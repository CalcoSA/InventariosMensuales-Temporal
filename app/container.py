...
from app.repositories.monthly_factors import MonthlyFactorsRepository
...
class Container:
    def __init__(self, config, *, drive=None, sheets=None, identity_provider=None):
        ...
        self.admin = MonthlyAdminService(self.bases, self.inventory_repository, self.identity, MonthlyFactorsRepository(self.bases))
